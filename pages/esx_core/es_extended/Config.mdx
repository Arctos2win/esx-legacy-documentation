...
# ESX Config
This topic explains the Configs provided in es_extened.
...
<Callout type="warning">
    Logging to discord is inefficient and should not be used on larger scale servers. 
    Also keep in mind if you log to much in a short time span the webhook might get timeouted for a while by discord.
</Callout>
