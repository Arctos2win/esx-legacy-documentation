...
export function ThemedImage({ type = "header" }) {
  ...
  const images = {
    ...
    OxygenServ: {
      light:
        "https://www.oxygenserv.com/wp-content/uploads/2022/06/logo_oxygenserv.svg",
      dark: "https://www.oxygenserv.com/wp-content/uploads/2022/06/logo_oxygenserv_blanc.svg",
    },
    RTXDEV: {
      light:
        "https://esx.s3.fr-par.scw.cloud/rtx-logo-black.png",
      dark: "https://dunb17ur4ymx4.cloudfront.net/webstore/logos/0e83be93ba8d67a6ca7fc101e29c112964a470f1.png",
    },
    NXG: {
      light: "https://esx.s3.fr-par.scw.cloud/n-logo-black.png",
      dark: "https://esx.s3.fr-par.scw.cloud/n-logo-white.png",
    }
  };
  ...
  const style =
    type === "header"
      ? {
          ...
          lineHeight: "80px",
          height: "60px",
          backgroundImage: `url('${images[type][_theme]}')`,
  ...
  return (
    <div style={style}>
      {type !== "header" && <img src={images[type][_theme]} />}
    </div>
  );
}
