...
**Arguments**
<ArgumentsTable rows={[
    { arg: 'isMale', type: 'boolean', description: 'Should the player be set to a male ped?' }, 
]} /> 
...
**Arguments**
<ArgumentsTable rows={[
    { arg: 'skin', type: 'table', description: 'A table containing all skin details.' }, 
]} /> 
...
**Arguments**
<ArgumentsTable rows={[
    { arg: 'callback', type: 'function', description: 'Callback function that will return the data' }, 
]} /> 
