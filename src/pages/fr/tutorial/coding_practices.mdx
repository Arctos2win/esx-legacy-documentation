...
For more information check the [Annotations](/fr/tutorial/coding_practices/annotations) section.
...
### Tables
Tables is a powerful data structure in Lua, but it is resource intensive. It is important to use tables wisely and avoid creating unnecessary tables.
...
- `GetHashKey('adder') -> joaat('adder') or `adder\``
...
### Features
- `const` & `close` keyword for defining constants.
- `goto` statement.
