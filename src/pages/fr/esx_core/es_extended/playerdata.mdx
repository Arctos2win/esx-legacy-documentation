...
Read [Import method Tutorial](/fr/tutorial/updating/#import-method) for further details.
...
Can be set via [`xPlayer.set`](/fr/esx_core/es_extended/server/xplayer.mdx#set) and get via [`xPlayer.get`](/fr/esx_core/es_extended/server/xplayer.mdx#get) on serverside.
...
Can be set via [`xPlayer.setMeta`](/fr/esx_core/es_extended/server/xplayer.mdx#setmeta) and get via [`xPlayer.getMeta`](/fr/esx_core/es_extended/server/xplayer.mdx#getmeta) on serverside.
